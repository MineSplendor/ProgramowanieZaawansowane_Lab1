...
namespace AdvancedProgramming_Lesson1.Controllers
{
    public class MeatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,ExpirationDate,Weight,Fat,Price")] Meat meat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,ExpirationDate,Weight,Fat,Price")] Meat meat)
        {
            if (id != meat.Id)
            {
                return NotFound();
