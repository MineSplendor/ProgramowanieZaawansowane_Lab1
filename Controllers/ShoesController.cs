...
namespace AdvancedProgramming_Lesson1.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Material,Size,Weight,Length,Price")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Material,Size,Weight,Length,Price")] Shoe shoe)
        {
            if (id != shoe.Id)
            {
                return NotFound();
