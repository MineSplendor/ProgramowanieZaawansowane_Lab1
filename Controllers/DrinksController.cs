...
namespace AdvancedProgramming_Lesson1.Controllers
{
    public class DrinksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Flavor,ExpirationDate,Capacity,Price")] Drink drink)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Flavor,ExpirationDate,Capacity,Price")] Drink drink)
        {
            if (id != drink.Id)
            {
                return NotFound();
